...
//
//  AppDelegate.m
//  PhoneGapFoo-BrokenCompilation
//
//  Created by Matthew Baxter-Reynolds on 13/02/2012.
//  Copyright AMX Software Ltd 2012. All rights reserved.
//
...
{    
    ...
    if (url && [url isKindOfClass:[NSURL class]]) {
		...
		NSLog(@"PhoneGapFoo-BrokenCompilation launchOptions = %@", url);
    }    
